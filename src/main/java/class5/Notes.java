...
public class Notes {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 1) while loop 2) do while loop 3) for loop 4) enhanced for loop/ for each
		 * loop
		 * 
		 * 
		 * Every loop will the below 3 points 1) Initialization (where to start)
		 * 2)condition (how many times) 3) Inc/dec
		 * 
		 * while (condition) { statements; inc/dec; }
		 * 
		 * do { statements; inc/dec; } while (condition);
		 *
		 *
		 *
		 * for loop 
